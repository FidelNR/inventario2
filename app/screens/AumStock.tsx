...
export default function AumStock ({ route, navigation }: any){
    ...
    const handleGuardar = async () => {
        ...
        db.transaction(tx => {
            tx.executeSql(
                'INSERT INTO maxstock (idproducto, nombre, cantidad) VALUES (?, ?, ?)',
                [productId, productName, cantidad],
                () => console.log('Guardado en maxstock'),
    ...
    return (
        <SafeAreaView>
            <View>
                <Text>VISTA AUMENTAR STOCK</Text>
                ...
                <TextInput placeholder='Cantidad a agregar' placeholderTextColor={'#828894'} onChangeText={setCantidad}/>
